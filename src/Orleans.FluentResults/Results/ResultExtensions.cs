...
public static class ResultExtensions
{
    ...
    /// <param name="result"></param>
    /// <param name="bindAction">Action that may fail.</param>
    public static async ValueTask<Result<TValue>> Bind<TValue>(this IResult<TValue> result, Func<ValueTask<Result<TValue>>> bindAction)
    {
        ArgumentNullException.ThrowIfNull(result);
        ArgumentNullException.ThrowIfNull(bindAction);
        var boundResult = new Result<TValue>(result.Value, result.Reasons);
    ...
    /// <param name="result"></param>
    /// <param name="bindAction">Action that may fail.</param>
    public static async ValueTask<Result> Bind<TValue>(this IResult<TValue> result, Func<TValue, ValueTask<Result>> bindAction)
    {
        ArgumentNullException.ThrowIfNull(result);
        ArgumentNullException.ThrowIfNull(bindAction);
        var boundResult = new Result(result.Reasons);
    ...
    public static async Task<Result<TValue>> Bind<TValue>(this IResult<TValue> result, Func<TValue, Task<Result<TValue>>> bindAction)
    {
        ArgumentNullException.ThrowIfNull(result);
        ArgumentNullException.ThrowIfNull(bindAction);
        var boundResult = new Result<TValue>(result.Value, result.Reasons);
    ...
    /// <param name="result"></param>
    /// <param name="bindAction">Transformation that may fail.</param>
    public static async ValueTask<Result<TValue>> Bind<TValue>(this IResult<TValue> result, Func<TValue, ValueTask<Result<TValue>>> bindAction)
    {
        var boundResult = new Result<TValue>(result.Value, result.Reasons);
        if (result.IsFailed)
        {
