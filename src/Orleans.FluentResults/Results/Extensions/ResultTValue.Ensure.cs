...
public static partial class ResultTValueExtensions
{
    ...
    public static Task<Result<T>> EnsureAsync<T>(this Task<Result<T>> resultTask, bool condition, string errorMessage, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(errorMessage);
    ...
    /// <param name="errorMessages"></param>
    /// <param name="configureAwait"></param>
    public static Task<Result<T>> EnsureAsync<T>(this Task<Result<T>> resultTask, bool condition, IEnumerable<string> errorMessages, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(errorMessages);
    ...
    /// <param name="error"></param>
    /// <param name="configureAwait"></param>
    public static async Task<Result<T>> EnsureAsync<T>(this Task<Result<T>> resultTask, bool condition, IError error, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(error);
    ...
    /// <param name="errors"></param>
    /// <param name="configureAwait"></param>
    public static async Task<Result<T>> EnsureAsync<T>(this Task<Result<T>> resultTask, bool condition, IEnumerable<IError> errors, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(errors);
        var result = await resultTask.ConfigureAwait(configureAwait);
        if (result.IsSuccess && !condition)
    ...
    /// <param name="exception"></param>
    /// <param name="configureAwait"></param>
    public static Task<Result<T>> EnsureAsync<T>(this Task<Result<T>> resultTask, bool condition, Exception exception, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(exception);
    ...
    /// <param name="exceptions"></param>
    /// <param name="configureAwait"></param>
    public static Task<Result<T>> EnsureAsync<T>(this Task<Result<T>> resultTask, bool condition, IEnumerable<Exception> exceptions, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(exceptions);
    ...
    /// <param name="errorMessage"></param>
    /// <param name="configureAwait"></param>
    public static ValueTask<Result<T>> EnsureAsync<T>(this ValueTask<Result<T>> resultTask, bool condition, string errorMessage, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(errorMessage);
        return resultTask.EnsureAsync(condition, ResultSettings.Current.ErrorFactory(errorMessage), configureAwait);
    }
    ...
    /// <param name="errorMessages"></param>
    /// <param name="configureAwait"></param>
    public static ValueTask<Result<T>> EnsureAsync<T>(this ValueTask<Result<T>> resultTask, bool condition, IEnumerable<string> errorMessages, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(errorMessages);
        return resultTask.EnsureAsync(condition, errorMessages.Select(ResultSettings.Current.ErrorFactory), configureAwait);
    }
    ...
    /// <param name="error"></param>
    /// <param name="configureAwait"></param>
    public static async ValueTask<Result<T>> EnsureAsync<T>(this ValueTask<Result<T>> resultTask, bool condition, IError error, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(error);
        var result = await resultTask.ConfigureAwait(configureAwait);
        if (result.IsSuccess && !condition)
    ...
    /// <param name="errors"></param>
    /// <param name="configureAwait"></param>
    public static async ValueTask<Result<T>> EnsureAsync<T>(this ValueTask<Result<T>> resultTask, bool condition, IEnumerable<IError> errors, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(errors);
        var result = await resultTask.ConfigureAwait(configureAwait);
        if (result.IsSuccess && !condition)
    ...
    /// <param name="exception"></param>
    /// <param name="configureAwait"></param>
    public static ValueTask<Result<T>> EnsureAsync<T>(this ValueTask<Result<T>> resultTask, bool condition, Exception exception, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(exception);
        return resultTask.EnsureAsync(condition, ResultSettings.Current.ExceptionalErrorFactory(exception.Message, exception), configureAwait);
    }
    ...
    /// <param name="exceptions"></param>
    /// <param name="configureAwait"></param>
    public static ValueTask<Result<T>> EnsureAsync<T>(this ValueTask<Result<T>> resultTask, bool condition, IEnumerable<Exception> exceptions, bool configureAwait = true)
    {
        ArgumentNullException.ThrowIfNull(exceptions);
        return resultTask.EnsureAsync(condition, exceptions.Select(exception => ResultSettings.Current.ExceptionalErrorFactory(exception.Message, exception)), configureAwait);
    }
