...
public static partial class ResultExtensions
{
    ...
    /// <param name="condition"></param>
    /// <param name="errorMessage"></param>
    public static Task<Result> EnsureAsync(this Task<Result> resultTask, bool condition, string errorMessage)
    {
        ArgumentNullException.ThrowIfNull(errorMessage);
    ...
    /// <param name="condition"></param>
    /// <param name="errorMessages"></param>
    public static Task<Result> EnsureAsync(this Task<Result> resultTask, bool condition, IEnumerable<string> errorMessages)
    {
        ArgumentNullException.ThrowIfNull(errorMessages);
    ...
    /// <param name="condition"></param>
    /// <param name="exception"></param>
    public static Task<Result> EnsureAsync(this Task<Result> resultTask, bool condition, Exception exception)
    {
        ArgumentNullException.ThrowIfNull(exception);
    ...
    /// <param name="condition"></param>
    /// <param name="exceptions"></param>
    public static Task<Result> EnsureAsync(this Task<Result> resultTask, bool condition, IEnumerable<Exception> exceptions)
    {
        ArgumentNullException.ThrowIfNull(exceptions);
    ...
    /// <param name="condition"></param>
    /// <param name="errorMessage"></param>
    public static ValueTask<Result> EnsureAsync(this ValueTask<Result> resultTask, bool condition, string errorMessage)
    {
        ArgumentNullException.ThrowIfNull(errorMessage);
        return resultTask.EnsureAsync(condition, ResultSettings.Current.ErrorFactory(errorMessage));
    }
    ...
    /// <param name="condition"></param>
    /// <param name="errorMessages"></param>
    public static ValueTask<Result> EnsureAsync(this ValueTask<Result> resultTask, bool condition, IEnumerable<string> errorMessages)
    {
        ArgumentNullException.ThrowIfNull(errorMessages);
        return resultTask.EnsureAsync(condition, errorMessages.Select(ResultSettings.Current.ErrorFactory));
    }
    ...
    /// <param name="condition"></param>
    /// <param name="exception"></param>
    public static ValueTask<Result> EnsureAsync(this ValueTask<Result> resultTask, bool condition, Exception exception)
    {
        ArgumentNullException.ThrowIfNull(exception);
        return resultTask.EnsureAsync(condition, ResultSettings.Current.ExceptionalErrorFactory(exception.Message, exception));
    }
    ...
    /// <param name="condition"></param>
    /// <param name="exceptions"></param>
    public static ValueTask<Result> EnsureAsync(this ValueTask<Result> resultTask, bool condition, IEnumerable<Exception> exceptions)
    {
        ArgumentNullException.ThrowIfNull(exceptions);
        return resultTask.EnsureAsync(condition, exceptions.Select(exception => ResultSettings.Current.ExceptionalErrorFactory(exception.Message, exception)));
    }
